...
public class Main {
    ...
    private static void reverse(int[] array){
        ...
        // swapped with the 1st half so the array is already fully reversed at the half way into the array

        for(int i=0; i < halfLength; i++){

            int temp = array[i]; // saving the element at index: i to the "temp" variable
            array[i] = array[maxIndex - i]; // moving the array to = the highest index value.
