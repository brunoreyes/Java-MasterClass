        ...
        while (currentItem != null){
            ...
            if(comparison < 0){
                ...
                if(currentItem.next() != null){
                    ...
                    // there's no node to the right, so now we will at it
                ...
                // equal so don't add ( not adding duplicates)
                System.out.println(newItem.getValue() + " is already present");
                return false;
            }
        }
        // This point isn't reachable but adding return to satisfy Java's syntax
        return false;
    }
