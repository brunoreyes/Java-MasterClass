...
//        languages.remove("Lisp");
        if (languages.remove("Algol",
//                "a family of algorithmic languages"
                "an algorithmic language" // testing method
        )
        ){
        ...
        // .replace(key, newValue) = replace a value of a key OR
        // .replace(key, oldValue, newValue) // to ensure if current value is being updated
